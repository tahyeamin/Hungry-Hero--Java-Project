...
public class EmonProfile implements ActionListener, IEmonProfile
{
	...
	private String f;
	public EmonProfile(String user)
	{
		f=user;
		
		frame = new JFrame("Emon");
		
		ImageIcon framelogo = new ImageIcon("icons/framelogo.jpg");
		Image image1 = new ImageIcon("icons/emon.png").getImage().getScaledInstance(537, 560, Image.SCALE_SMOOTH);
		ImageIcon emon = new ImageIcon(image1);
