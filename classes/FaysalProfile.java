...
public class FaysalProfile implements ActionListener, IFaysalProfile
{
	...
	private String f;
	public FaysalProfile(String user)
	{
		f=user;
		
		frame = new JFrame("Faysal Ahmmed");
		
		ImageIcon framelogo = new ImageIcon("icons/framelogo.jpg");
		ImageIcon faysal = new ImageIcon("icons/faysalProfile.jpg");
