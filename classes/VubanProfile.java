...
public class VubanProfile implements ActionListener, IVubanProfile
{
	...
	private String f;
	public VubanProfile(String user)
	{
		f=user;
		
		frame = new JFrame("Vuban Malek");
		
		ImageIcon framelogo = new ImageIcon("icons/framelogo.jpg");
		Image image1 = new ImageIcon("icons/vuban.png").getImage().getScaledInstance(537, 560, Image.SCALE_SMOOTH);
		ImageIcon vuban = new ImageIcon(image1);
